    ...
    private lazy var moreNavigationItem = UIBarButtonItem(
        ...
        menu: UIMenu(title: "", children: [
            UIDeferredMenuElement.uncached { [self] completion in
                if let menu = NCContextMenuViewer(metadata: currentViewController.metadata, controller: self.tabBarController as? NCMainTabBarController, viewController: self.tabBarController, webView: false, sender: self).viewMenu() {
